...
namespace FIMSpace.FProceduralAnimation
{
    ...
    public partial class RagdollProcessor
    {
        ...
        [Tooltip("Damp power for physical joints - can reduce bouncy effect but require more spring")] public float ConfigurableDamp = 18;
        ...
        internal void Initialize(MonoBehaviour caller, Transform objectWithAnimator, Transform customRagdollAnimator = null, Transform rootBone = null)
        {
            Initialized = false;

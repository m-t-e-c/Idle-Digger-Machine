...
namespace FIMSpace.AnimationTools
{
    ...
    public class ADArmatureSetup
    {
        ...
        internal void Bake_Prepare(Transform anim, AnimationClip originalClip, AnimationDesignerSave save, ADClipSettings_Main main)
        {
            ...
            {
                var b = BonesSetup[i];
                b.ResetCurvesAndNamesForBaking();
            }

            if (RootBoneReference != null)
            {
                RootBoneReference._Bake_IsRoot = true;
                RootBoneReference.ResetCurvesAndNamesForBaking();
            }

            if (PelvisBoneReference != null) PelvisBoneReference.ResetCurvesAndNamesForBaking();
            ...
            if (!requestMet)
            {
                ...
                adRef.ResetCurvesAndNamesForBaking();
                adRef.BakeBone = true;

...
namespace FIMSpace.AnimationTools
{
    ...
    public class ADBoneReference
    {
        ...
        internal void DefineBakePathName(Transform skelRootBone)
        {
            ...
            if (TempTransform == null) return;
            BoneBakePathName = AnimationUtility.CalculateTransformPath(TempTransform, skelRootBone);
        }
        ...
        public void ResetCurvesAndNamesForBaking()
        {
        ...
        internal void SaveCurvesForClip(ref AnimationClip clip, float reduction, bool animType = false, SaveCurvesMode mode = SaveCurvesMode.All)
        {
            ...
            if (!HumanoidBoneDefined) relPath = BoneBakePathName;
